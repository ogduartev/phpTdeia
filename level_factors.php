...
class level_factors extends block
{
  ...
  function display()
  {
    ...
    {  
      ...
      $str.="  <label class=\"level\" for=\"factorLevel\">".$this->text("level_Depth").": </label>";
      $str.="  <input class=\"level\" type=\"range\" name=\"factorLevel\" min=\"0\" max=\"".$maxLevel."\" value=\"".$level."\" onChange=\"submit();\">\n";
      $str.="  <output class=\"level\" for=\"factorLevel\" id=\"factorLevelOutput\">".$level."</output>";
      $str.="  </form>\n";
      echo $str;
    }
  }
